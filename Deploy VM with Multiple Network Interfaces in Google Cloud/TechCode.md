# 🌐 Deploy VM with Multiple Network Interfaces in Google Cloud 🚀 [![Open Lab](https://img.shields.io/badge/Open-Lab-blue?style=flat)]()
...
```
```bash
gcloud compute instances create multi-nic-vm --zone=$REGION --machine-type=e2-medium --network-interface=network=my-vpc1,subnet=subnet-a --network-interface=network=my-vpc2,subnet=subnet-b
```
