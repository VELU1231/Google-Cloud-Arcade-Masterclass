...
echo
echo "${MAGENTA_TEXT}${BOLD_TEXT}Subscribe to DrVelu for more! 👇${RESET_FORMAT}"
echo "${BLUE_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@DrVelu${RESET_FORMAT}"
echo
