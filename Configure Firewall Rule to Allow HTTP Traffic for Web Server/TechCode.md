# 🌐 Configure Firewall Rule to Allow HTTP Traffic for Web Server 🚀 [![Open Lab](https://img.shields.io/badge/Open-Lab-blue?style=flat)]()
...
### Ab logon ko kaun samjhaye ki GCP labs me code likhne ka tarika same hi hota hai.
```bash
