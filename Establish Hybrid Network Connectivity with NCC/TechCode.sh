...
echo "${MAGENTA_TEXT}${BOLD_TEXT}DrVelu – Subscribe Here: https://www.youtube.com/@DrVelu${RESET_FORMAT}"
...
echo
echo "${MAGENTA_TEXT}${BOLD_TEXT}Watch more cloud tutorials on DrVelu: https://www.youtube.com/@DrVelu${RESET_FORMAT}"
...
echo
echo "${MAGENTA_TEXT}${BOLD_TEXT}Support the channel: DrVelu – https://www.youtube.com/@DrVelu${RESET_FORMAT}"
...
echo "${YELLOW_TEXT}${BOLD_TEXT}=======================================================${RESET_FORMAT}"
echo
echo "${RED_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@DrVelu${RESET_FORMAT}"
